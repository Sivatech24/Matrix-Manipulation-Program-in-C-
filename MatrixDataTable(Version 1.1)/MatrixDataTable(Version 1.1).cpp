...
public:
    ...
    void displayMatrix() const {
        ...
        for (int i = 0; i < matrix[0].size(); ++i) {
            std::cout << std::setw(cellWidth) << "Col " << i;
        }
        std::cout << "\n";

        // Display matrix rows with row indices
        for (int i = 0; i < matrix.size(); ++i) {
            std::cout << std::setw(cellWidth) << "Row " << i;
    ...
    // Function to find the average value of all elements in the matrix
    ...
    // Function to search for a specific value in the matrix
    ...
    do {
        ...
        switch (opt) {
            ...
            case 7:
                ...
                std::cout << "Sum of Matrix: " << intMatrix.sum() << "\n";
                break;

            case 8:
                // Finding the average value of all elements in the matrix
                std::cout << "Average of Matrix: " << intMatrix.average() << "\n";
                break;

            case 9: {
                // Searching for a specific value in the matrix
                int searchValue;
                std::cout << "Enter the value to search in the matrix: ";
                std::cin >> searchValue;
                if (intMatrix.searchValue(searchValue)) {
                    std::cout << "Value found in the matrix.\n";
                } else {
                    std::cout << "Value not found in the matrix.\n";
                }
                break;
            }
            case 10:
